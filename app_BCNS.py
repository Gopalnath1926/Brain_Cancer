...
def main():
    ...
    <h1 style ="color:black;text-align:center;">WBP tool for brain cancer survival (Prototype)</h1>
    </div>
    """
...
st.write('_NB: This prototype (developed based on a limited number of observations) is intended only for demonstration of the proposal tool and not as a replacement for professional medical counseling, diagnosis, or treatment. The authors and the institution do not guarantee the outcome of this prototype for any particular patient._')
